...
def main(local_rank, world_size):
    ...
    student_net = create_Res18(1000, cfg.POST.DBB_TYPE, False)
    ...
    # for cycle_time in range(cfg.POST.CYCLE):
        if cycle_time == 0:
            ...
            student_net.reparam()    # rep branches into Rep_conv
            ...
            ckpt = torch.load(os.path.join(cfg.OUT_DIR, "checkpoints", "cycle_"+str(cycle_time-1)+".pyth"))
            student_net.module.load_state_dict(ckpt['model_state'])
            student_net.module.reparam() # rep branches into Rep_conv
            ...
            # clear
            del criterion, optimizer, scheduler, ckpt
