...
def main(local_rank, world_size):
    ...
    # Networks
    student_net = create_Res18(1000, cfg.POST.DBB_TYPE, False).to(local_rank)
...
def train_epoch(cur_epoch, student_net, teacher_net, train_loader, train_meter, optimizer, scheduler, criterion, rank):
    teacher_net.eval()
    student_net.train()
