...
def transforms_mnist(cutout_length, aug_type):
...
def transforms_fashionmnist(cutout_length, aug_type):
...
def transforms_svhn(cutout_length, aug_type):
...
def transforms_cifar100(cutout_length, aug_type):
    ...
    elif aug_type == 'auto_augment':
        from datasets.auto_augment_cs import CIFAR10Policy
        train_transform = transforms.Compose(
            [
...
def transforms_cifar10(cutout_length, aug_type):
